...
@Component({
  selector: 'app-requisicion-oc',
  templateUrl: './requisicion-oc.component.html',
  styleUrls: ['./requisicion-oc.component.css'],
  providers: [RequisicionService]
})
export class RequisicionOcComponent implements OnInit {
